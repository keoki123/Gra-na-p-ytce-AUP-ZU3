...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ HDMI_PS2_clk_wiz_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_HDMI_PS2_clk_wiz_0_0_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_HDMI_PS2_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_HDMI_PS2_clk_wiz_0_0_clk_wiz is
  signal Clk_100MHz_HDMI_PS2_clk_wiz_0_0 : STD_LOGIC;
  signal Clk_125Mhz_HDMI_PS2_clk_wiz_0_0 : STD_LOGIC;
  signal Clk_25MHz_HDMI_PS2_clk_wiz_0_0 : STD_LOGIC;
  signal clk_in1_HDMI_PS2_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_HDMI_PS2_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => Clk_25MHz_HDMI_PS2_clk_wiz_0_0,
      O => Clk_25MHz
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => Clk_125Mhz_HDMI_PS2_clk_wiz_0_0,
      O => Clk_125Mhz
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => Clk_100MHz_HDMI_PS2_clk_wiz_0_0,
      O => Clk_100MHz
    );
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_HDMI_PS2_clk_wiz_0_0_clk_wiz
     port map (
