...
HD_PWD='C:/Users/lab/Desktop/HDMI_PS2 ---- Kopia/HDMI_PS2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_PS2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_PS2_wrapper.tcl
