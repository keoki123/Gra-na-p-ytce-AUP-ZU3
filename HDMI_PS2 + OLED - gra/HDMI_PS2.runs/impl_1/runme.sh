...
HD_PWD='C:/Users/lab/Desktop/HDMI_PS2 ---- Kopia/HDMI_PS2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_PS2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_PS2_wrapper.tcl -notrace
