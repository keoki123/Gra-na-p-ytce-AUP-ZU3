...
HD_PWD='C:/XnxPrj/HDMI_PS2/HDMI_PS2.runs/HDMI_PS2_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_PS2_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_PS2_clk_wiz_0_0.tcl
